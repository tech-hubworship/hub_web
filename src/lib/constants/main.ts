...
export const Activity: ActivityListType = {
  [ActivityType.APPJAM]: {
    ...
    description: [
      ...
      {
        content:
          "예요. 데모데이 에서 각 파트 현직자들에게 결과물에 대한 피드백을 받아요.",
        color: "white",
      },
    ],
  },
  [ActivityType.SOPKATHON]: {
    ...
    description: [
      ...
      {
        content:
          "간 기획, 디자인, 개발 파트가 팀을 이뤄 최소 단위의 서비스를 제작하는 솝트내 ",
        color: "white",
      },
  ...
  [ActivityType.STUDY]: {
    ...
    description: [
      ...
      {
        content: "스터디와 다양한 파트원들과 친목을 쌓을 수 있는 네트워킹",
        color: "yellow",
      },
      {
...
export const OWN_ORGANIZATION_LIST: {
...
}[] = [
  {
    ...
    description: [
      ...
      {
        content: "1, 2차 행사와 다양한 이벤트를 직접 브랜딩, 기획, 진행하며",
        weight: "bold",
      },
      {
        content:
  ...
  },
  {
    ...
    description: [
      {
        content: "솝트를 한 기수 이상 수료한 사람들이 모여 ",
        weight: "normal",
      },
