    ...
    <PageLayout>
      <Container>
        ...
        <Section>
          ...
          <Content>
            본 약관은 HUB가 제공하는 HUB Worship 서비스(이하 &quot;서비스&quot;라
            한다)의 이용과 관련하여 HUB와 회원 간의 권리, 의무 및 책임사항,
        ...
        <Section>
          ...
          <Content>
            ...
            <List>
              <ListItem>
                1. &quot;서비스&quot;란 HUB가 제공하는 HUB Worship 관련 모든
                서비스를 의미합니다.
              </ListItem>
              <ListItem>
                2. &quot;회원&quot;이란 본 약관에 동의하고 HUB와 서비스
                이용계약을 체결한 자를 의미합니다.
              </ListItem>
              <ListItem>
                3. &quot;아이디(ID)&quot;란 회원의 식별과 서비스 이용을
                위하여 회원이 정하고 HUB가 승인하는 문자와 숫자의 조합을
                의미합니다.
              </ListItem>
              <ListItem>
                4. &quot;비밀번호&quot;란 회원이 부여받은 아이디와 일치되는
        ...
        <Section>
          ...
          <Content>
            <List>
              <ListItem>
                1. HUB는 본 약관의 내용을 회원이 쉽게 알 수 있도록 서비스 초기
                화면에 게시합니다.
              </ListItem>
              <ListItem>
                2. HUB는 필요한 경우 관련 법령을 위배하지 않는 범위에서 본
                약관을 개정할 수 있습니다.
              </ListItem>
              <ListItem>
                3. HUB가 약관을 개정할 경우에는 적용일자 및 개정사유를
        ...
        <Section>
          ...
          <Content>
            <List>
              <ListItem>
                1. 회원가입은 신청자가 온라인으로 HUB에서 제공하는 소정의
                가입신청 양식에서 요구하는 사항을 기록하여 가입을 완료하는
                것으로 성립됩니다.
              </ListItem>
              <ListItem>
                2. HUB는 다음 각 호에 해당하는 경우에는 회원가입을 거부할 수
                있습니다:
                <SubList>
        ...
        <Section>
          ...
          <Content>
            <List>
              <ListItem>
                1. HUB는 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장,
                통신의 두절 등의 사유가 발생한 경우에는 서비스의 제공을
                일시적으로 중단할 수 있습니다.
              </ListItem>
              <ListItem>
                2. HUB는 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로
                인하여 회원 또는 제3자가 입은 손해에 대하여 배상합니다. 단,
                HUB가 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
                아니합니다.
              </ListItem>
            </List>
          </Content>
        ...
        <Section>
          ...
          <Content>
            <List>
              <ListItem>
                1. HUB와 회원은 서비스와 관련하여 발생한 분쟁을 원만하게 해결하기 위하여 필요한 모든 노력을 하여야 합니다.
              </ListItem>
              <ListItem>
                2. 제1항의 규정에도 불구하고 분쟁으로 인하여 소송이 제기될 경우 소송은 HUB의 본사 소재지를 관할하는 법원의 관할로 합니다.
              </ListItem>
            </List>
          </Content>
        </Section>
        ...
        <Section>
          ...
          <Content>본 약관은 2025년 9월 30일부터 시행됩니다.</Content>
        </Section>
      </Container>
    </PageLayout>
  );
